...
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {lr_clk_dac}]
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports {m_clk_dac}]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {tx_i2s_data}]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports {s_clk_dac}]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {lr_clk_adc}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {m_clk_adc}]
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports {rx_i2s_data}]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {s_clk_adc}]
set_property PULLUP true [get_ports {s_clk_dac}]
set_property PULLUP true [get_ports {tx_i2s_data}]
set_property PULLUP true [get_ports {s_clk_adc}]
set_property PULLUP true [get_ports {rx_i2s_data}]
